...
const features = [
  {
    ...
    desc: "Expand any complex task into clear, estimable subtasks with one click.",
  },
  {
    icon: FileText,
    title: "AI Sprint Summaries",
    desc: "Concise progress reports highlighting what's done, pending and at risk.",
  },
  {
    icon: Users,
    title: "Real-Time Collaboration",
    desc: "See teammates' moves instantly with live presence and an activity feed.",
  },
  {
    icon: LayoutGrid,
    title: "Drag & Drop Boards",
    desc: "Smooth, fast kanban with Todo, In Progress, Review and Done.",
  },
  {
    icon: Command,
    title: "Command Menu",
    desc: "Press ⌘K to jump anywhere, search tasks, or spin up a board.",
  },
];
