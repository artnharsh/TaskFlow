...
import { Sparkles, ArrowRight, TrendingUp, CheckCircle2, Users, Gauge, Star } from "lucide-react";
      ...
      <div className="brand-gradient animate-gradient-pan relative overflow-hidden rounded-[2rem] px-6 pb-56 pt-16 text-center shadow-[var(--shadow-lift)] sm:rounded-[2.5rem] sm:pb-64 sm:pt-24">
        ...
        <div className="pointer-events-none absolute inset-0" aria-hidden="true">
          ...
          <div className="absolute inset-0 mix-blend-screen">
            <motion.div
              ...
              style={{
                background: "radial-gradient(closest-side, rgba(124,214,164,0.85), transparent)",
              }}
            ...
            <motion.div
              ...
              style={{
                background: "radial-gradient(closest-side, rgba(150,236,186,0.7), transparent)",
              }}
            ...
            <motion.div
              ...
              style={{
                background: "radial-gradient(closest-side, rgba(196,250,216,0.6), transparent)",
              }}
            ...
            <motion.div
              ...
              style={{
                background: "radial-gradient(closest-side, rgba(90,200,140,0.7), transparent)",
              }}
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-xl text-[15px] leading-relaxed text-white/80 sm:text-lg">
            Flowboard turns a one-line goal into a prioritized backlog and keeps your whole team
            moving in real time — so you plan less and ship more.
          </p>
      ...
      >
        <div className="grid items-end gap-4 sm:grid-cols-12">
          ...
          <div className="rounded-3xl border border-line bg-surface p-5 text-left shadow-[var(--shadow-lift)] sm:col-span-3">
            ...
            <p className="mt-3 font-display text-3xl font-semibold tabular tracking-tight">24</p>
            <p className="text-xs text-faint">tasks in flight</p>
            <div className="mt-4 grid grid-cols-2 gap-2">
              <div className="rounded-xl bg-surface-2 p-2.5">
                <p className="font-display text-base font-semibold tabular">18</p>
                <p className="text-[10px] text-muted">Done</p>
              </div>
              <div className="rounded-xl bg-surface-2 p-2.5">
                <p className="font-display text-base font-semibold tabular">6</p>
          ...
          <div className="overflow-hidden rounded-3xl border border-line bg-surface text-left shadow-[var(--shadow-lift)] sm:col-span-6 sm:-translate-y-8">
            ...
            <div className="flex items-center gap-2 border-b border-line px-4 py-3">
              ...
              <span className="ml-2 text-xs font-medium text-muted">Flowboard · Sprint 14</span>
            ...
            <div className="p-5">
              ...
              {/* velocity chart */}
              <svg viewBox="0 0 480 120" preserveAspectRatio="none" className="mt-4 h-28 w-full">
                <defs>
          ...
          <div className="rounded-3xl border border-line bg-surface p-5 text-left shadow-[var(--shadow-lift)] sm:col-span-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold tracking-tight">AI generated</span>
            </div>
      ...
      >
        <div className="flex flex-col items-start justify-between gap-5 sm:flex-row sm:items-end">
          <h2 className="max-w-xl font-display text-[clamp(26px,3.6vw,40px)] font-semibold leading-[1.08] tracking-tight">
            Real results for teams that <span className="text-gradient">ship faster</span>
          </h2>
          <Link to="/register">
            ...
            >
              ...
              <div>
                <p className="font-display text-2xl font-semibold tabular leading-none tracking-tight">
                  {s.value}
                  {s.suffix && <span className="text-base font-medium text-faint">{s.suffix}</span>}
                </p>
