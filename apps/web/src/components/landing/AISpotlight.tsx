      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-4 max-w-md leading-relaxed text-white/80">
            Stop staring at an empty board. Flowboard's AI plans, breaks down and reports on your
            work so you can focus on shipping.
          </p>
            ...
            <div className="space-y-2">
              {mockTasks.map((t, i) => (
                ...
                >
                  ...
                  />
                  <span className="flex-1 truncate text-sm text-white/90">{t.title}</span>
