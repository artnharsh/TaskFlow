...
const steps = [
  {
    ...
    desc: "Spin up a board pre-built with Todo, In Progress, Review and Done — in one click.",
  },
  {
    icon: Sparkles,
    title: "Let AI draft your backlog",
    desc: "Describe your goal and watch a prioritized set of tasks appear, ready to refine.",
  },
  {
    icon: Rocket,
    title: "Collaborate & ship",
    desc: "Assign, drag and track in real time while AI keeps everyone in sync.",
  },
];
